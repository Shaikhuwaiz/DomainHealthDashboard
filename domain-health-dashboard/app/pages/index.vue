    ...
    <div class="mx-auto max-w-6xl space-y-4">
      ...
      >
        <input
          ...
          class="w-full rounded-lg border border-slate-700 bg-slate-900/60 px-4 py-2.5 text-sm text-white placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-slate-500"
        />
        ...
        >
          <select
            ...
            class="w-full rounded-lg border border-slate-700 bg-slate-900/60 px-4 py-2.5 text-sm text-white sm:w-48"
          >
          ...
          <button
            ...
            class="w-full rounded-lg  bg-black px-3 py-2 text-xs  sm:w-auto"
          >
            Toggle API Down
          </button>
        </div>
